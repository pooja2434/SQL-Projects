...
select cus.customer_id,cus.first_name,cus.last_name,ord.item,
sum(ord.amount) as Order_amt,ship.shipping_id
from Customers cus  join Orders ord on cus.customer_id= ord.customer_id
 ...
 where ship.status='Pending' group  by cus.customer_id,cus.first_name,ord.item
 order by cus.customer_id


--To identify those customers from USA whose items delivered were Keyboard and Mouse
select cus.customer_id,cus.first_name,cus.last_name,ord.item, ship.status,sum(ord.amount) as order_amt from 
